...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div
      data-aos="fade-up"
      className="w-full p-3 bg-white rounded-2xl shadow-xl flex flex-col justify-start items-start gap-3"
    >
      <img
        src={imageSrc}
        alt={imageAlt}
...
export const AnotherProject = () => {
  ...
  const { visibleItems, isAllLoaded, handleLoadMore } = useVisibleProjects(anotherProjects);
