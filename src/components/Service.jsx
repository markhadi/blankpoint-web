...
const ServiceItem = ({ icon, heading, paragraph }) => {
  return (
    <li
      data-aos="fade-up"
      className="w-full xl:max-w-[333px] px-4 py-4 xl:py-10 bg-white rounded-lg shadow flex flex-col justify-start items-start gap-3 xl:gap-5 transition-all duration-300 hover:shadow-md hover:bg-gray-50"
    >
      {icon}
      <Heading
        level={3}
